...
def show_user_scenario(request):
    ...
    new_user_submission={'scenario_id': generated_scenario['scenario_id'],
                         ...
                         'is_police_officer': request.query_params.get('police_officer', False) == 'on',
                         'is_police_family': request.query_params.get('police_family', False) == 'on',
                         'is_public': request.query_params.get('public', False) == 'on',
